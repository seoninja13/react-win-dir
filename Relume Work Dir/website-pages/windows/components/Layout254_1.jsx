        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Personalize Your Windows to Match Your Style
            </h2>
            <p className="md:text-md">
              At Window World, we believe your windows should reflect your
              personal taste. Explore our extensive customization options to
        ...
        <div className="grid place-items-center gap-x-8 gap-y-12 sm:grid-cols-2 md:gap-y-16 lg:grid-cols-[1fr_1.5fr_1fr] lg:gap-x-12">
          <div className="grid w-full grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                Choose from a variety of interior and exterior colors to suit
                your style.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                Select from classic grid patterns like Colonial and Prairie to
                enhance your window design.
              </p>
            </div>
          </div>
          ...
          <div className="grid w-full grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16">
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                Opt for obscure or tinted glass to add privacy and style to your
                windows.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              ...
              <p>
                View swatches and examples to help visualize your custom window
                selections.
              </p>
            </div>
          </div>
