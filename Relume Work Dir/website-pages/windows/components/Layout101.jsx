        ...
        <div className="mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
          <div>
            ...
            <h3 className="text-5xl leading-[1.2] font-bold md:text-7xl lg:text-8xl">
              Flexible Financing Options for Your New Windows
            </h3>
          </div>
          <div>
            <p className="mb-6 md:mb-8 md:text-md">
              Investing in energy-efficient windows has never been easier.
              Explore our financing options to find a plan that fits your
              budget.
            </p>
            <div className="grid grid-cols-1 gap-6 py-2 sm:grid-cols-2">
              <div>
                ...
                <p>
                  Choose a payment plan that suits your financial needs and
              ...
              <div>
                ...
                <p>
                  Our simple application process makes securing financing quick
                  and hassle-free.
                </p>
              </div>
            </div>
