        ...
        <div className="grid w-full auto-cols-fr grid-cols-1 items-center justify-center gap-12 md:grid-cols-2 md:gap-10 lg:gap-x-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <blockquote className="text-xl font-bold md:text-2xl">
              "The Picture windows from Window World have transformed my home,
              allowing natural light to flood in while showcasing the beautiful
              Sacramento views. I appreciate the lifetime warranty and energy
              efficiency that comes with these stunning windows."
            </blockquote>
