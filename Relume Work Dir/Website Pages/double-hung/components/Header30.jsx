        ...
        <div className="flex max-h-[60rem] min-h-svh items-center justify-center py-16 text-center md:py-24 lg:py-28">
          <div className="w-full max-w-lg">
            <h1 className="mb-5 text-6xl font-bold text-text-alternative md:mb-6 md:text-9xl lg:text-10xl">
              Classic Double-Hung Windows in Sacramento
            </h1>
            <p className="text-text-alternative md:text-md">
              Discover the perfect blend of style and functionality with our
              double-hung windows. Designed for efficiency, they elevate your
              home's aesthetic while providing exceptional ventilation.
            </p>
