    ...
    >
      <div className="mx-[5%] max-w-[40rem] justify-self-start lg:mr-20 lg:ml-[5vw] lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Hinged Patio Doors in Sacramento, CA
        </h1>
        <p className="md:text-md">
          Transform your living space with our Hinged Patio Doors, offering a
          classic style that seamlessly connects your indoor and outdoor areas.
          Perfect for Sacramento's beautiful climate, these doors enhance your
          home's aesthetic while providing energy efficiency.
        </p>
