      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "The patio doors from Window World transformed our home, seamlessly
            connecting our indoor and outdoor spaces. We couldn't be happier
            with the quality and the energy efficiency!"
          </blockquote>
