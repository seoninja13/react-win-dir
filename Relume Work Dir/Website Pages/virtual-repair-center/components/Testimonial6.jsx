    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mb-12 w-full md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">Exceptional service and quality windows!</p>
        </div>
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              “Window World transformed my home with stunning windows!”
            </blockquote>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              “The installation team was professional and efficient!”
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
              ...
              <div className="mb-3 md:mb-4">
                ...
                <p>Project Manager, Sacramento</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              “I highly recommend Window World for their quality!”
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
