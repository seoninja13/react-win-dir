/**
 * Vertex AI Text Generation Test
 * 
 * This script tests text generation using the Google Cloud Vertex AI API
...
const LOCATION = 'us-west1'; // Using the user-specified location
...
async function run() {
  ...
  try {
    ...
    // Using gemini-1.0-pro which should be available in most regions
