// This script is meant to be copied and pasted into the Supabase SQL Editor
// It creates the logging table and related objects
...
FOR INSERT
WITH CHECK (auth.role() IN ('admin', 'service_role', 'anon'));
