          ...
          <div className="border rounded-md shadow-sm">
            <div className="border-none px-5 md:px-6">
              ...
              >
                ...
                <RxPlus className={`size-7 shrink-0 text-text-primary transition-transform duration-300 md:size-8 ${openItems.includes('item-0') ? 'rotate-45' : ''}`} />
              </button>
              {openItems.includes('item-0') && (
          ...
          <div className="border rounded-md shadow-sm">
            <div className="border-none px-5 md:px-6">
              ...
              >
                ...
                <RxPlus className={`size-7 shrink-0 text-text-primary transition-transform duration-300 md:size-8 ${openItems.includes('item-1') ? 'rotate-45' : ''}`} />
              </button>
          ...
          <div className="border rounded-md shadow-sm">
            <div className="border-none px-5 md:px-6">
              ...
              >
                ...
                <RxPlus className={`size-7 shrink-0 text-text-primary transition-transform duration-300 md:size-8 ${openItems.includes('item-2') ? 'rotate-45' : ''}`} />
              </button>
          ...
          <div className="border rounded-md shadow-sm">
            <div className="border-none px-5 md:px-6">
              ...
              >
                ...
                <RxPlus className={`size-7 shrink-0 text-text-primary transition-transform duration-300 md:size-8 ${openItems.includes('item-3') ? 'rotate-45' : ''}`} />
              </button>
          ...
          <div className="border rounded-md shadow-sm">
            <div className="border-none px-5 md:px-6">
              ...
              >
                ...
                <RxPlus className={`size-7 shrink-0 text-text-primary transition-transform duration-300 md:size-8 ${openItems.includes('item-4') ? 'rotate-45' : ''}`} />
              </button>
