    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:gap-x-20">
          ...
          <div>
            <div className="sticky mb-8 p-8 rounded-lg shadow-md bg-white" style={{ top: "30%" }}>
            ...
            <div className="sticky mb-8 p-8 rounded-lg shadow-md bg-white" style={{ top: "32%" }}>
                <div className="rb-6 mb-6 flex items-center">
                  <BiSolidStar className="mr-1 size-6" />
                  <BiSolidStar className="mr-1 size-6" />
                  <BiSolidStar className="mr-1 size-6" />
            ...
            <div className="sticky mb-8 p-8 rounded-lg shadow-md bg-white" style={{ top: "34%" }}>
                <div className="rb-6 mb-6 flex items-center">
                  <BiSolidStar className="mr-1 size-6" />
                  <BiSolidStar className="mr-1 size-6" />
                  <BiSolidStar className="mr-1 size-6" />
            ...
            <div className="sticky mb-8 p-8 rounded-lg shadow-md bg-white" style={{ top: "36%" }}>
                <div className="rb-6 mb-6 flex items-center">
                  <BiSolidStar className="mr-1 size-6" />
                  <BiSolidStar className="mr-1 size-6" />
                  <BiSolidStar className="mr-1 size-6" />
