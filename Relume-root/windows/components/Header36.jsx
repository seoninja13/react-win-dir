    ...
    >
      <div className="mx-[5%] sm:max-w-md md:justify-self-start lg:mr-20 lg:ml-[5vw] lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Upgrade Your Sacramento Home with Energy-Efficient Windows
        </h1>
        <p className="md:text-md">
          Save on energy bills and enhance your home's curb appeal. Experience
          the perfect blend of style and efficiency with our premium window
          options.
        </p>
