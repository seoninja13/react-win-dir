    ...
    >
      <div className="mx-[5%] sm:max-w-md md:justify-self-start lg:mr-20 lg:ml-[5vw] lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Custom Windows Tailored for Sacramento Homes
        </h1>
        <p className="md:text-md">
          Transform your home with our custom windows designed specifically for
          Sacramento's unique architecture and climate. Enjoy personalized
          styles that enhance energy efficiency and elevate your home's curb
          appeal.
        </p>
