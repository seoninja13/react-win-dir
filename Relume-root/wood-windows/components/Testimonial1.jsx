      ...
      <div className="container w-full max-w-lg">
        <div className="flex flex-col items-center text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "The wood windows from Window World transformed our home beautifully
            while keeping it energy efficient! We couldn't be happier with the
            quality and service we received."
          </blockquote>
