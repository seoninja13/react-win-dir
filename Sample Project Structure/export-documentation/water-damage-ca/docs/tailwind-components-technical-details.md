# Technical Details: Custom Tailwind Components Implementation

This document provides technical details about the implementation of custom Tailwind components to replace Ant Design components.
...
Error: "useForm must be used within a Form component"

Solution:
- Added Form.Provider component
- Changed from using Form.useForm() to using refs
- Added useRef import to all pages using refs

### 2. onPressEnter Error

Error: "Unknown event handler property `onPressEnter`"
