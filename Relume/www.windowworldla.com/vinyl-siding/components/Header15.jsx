        ...
        <div className="rb-12 mb-12 grid grid-cols-1 items-start gap-x-12 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-y-8 lg:mb-20 lg:gap-x-20 lg:gap-y-16">
          <div>
            <h1 className="text-6xl font-bold md:text-9xl lg:text-10xl">
              Vinyl Siding in Sacramento, CA
            </h1>
          </div>
          <div>
            <p className="md:text-md">
              Transform your home's exterior with durable vinyl siding that
              offers exceptional protection against the elements. Enjoy low
              maintenance and energy efficiency tailored for the Sacramento
              climate.
            </p>
