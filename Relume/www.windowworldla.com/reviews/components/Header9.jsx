          ...
          <div className="grid grid-rows-1 items-start gap-y-5 py-12 md:grid-cols-2 md:gap-x-12 md:gap-y-8 md:py-18 lg:gap-x-20 lg:gap-y-16 lg:py-20">
            ...
            <div>
              <p className="text-base text-text-primary md:text-md">
                Discover what our customers in Sacramento are saying about their
                experiences with Window World. Their satisfaction is our top
                priority, and we take pride in delivering exceptional service.
              </p>
