...
> **Breadcrumb Navigation**: [README.md](../../README.md) > [Documentation](../index.md) > [Architecture](./index.md) > Business Data Flow
...
- [GBP Enrichment Plan](../planning/gbp-enrichment-plan.md)
- [GBP Integration](../planning/gbp-integration.md)
